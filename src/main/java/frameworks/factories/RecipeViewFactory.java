...
import gui.frameworks.RecipeListGUI;
import gui.frameworks.RecipeDetailGUI;
import input.ports.use_case.LoadRecipesUseCase;
import input.ports.use_case.SelectRecipeUseCase;
import input.ports.use_case.NavigationUseCase;
import dto.use_case.RecipeDTO;
...
import interface_adapters.presentation.*;
import interface_adapters.persistence.JSONRecipeRepository;
